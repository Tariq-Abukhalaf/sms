...
if api_data:
    ...
    fact = "اللغز الذي نبحث عن مكانه، الحياة ذاك الشيء البعيد الذي نعيش به ولأجله، ولكننا غير مدركين السر الذي سيوصلنا للنجاة، لمعنى أن نصبح أُناساً قادرين على مواجهتها بقوة وحزم أشد"

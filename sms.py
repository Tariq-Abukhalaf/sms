...
while True:
    ...
    if api_data:
        fact = api_data["fact"]
        fact = "There are approximately 60,000 hairs per square inch on the back of a cat and about 120,000 per square inch on its underside.120,000 per hifgtrtq56789hi from other side i need"
